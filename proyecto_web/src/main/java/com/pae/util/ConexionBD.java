...
public class ConexionBD {
    ...
    static {
        // En un entorno web (Tomcat), el registro automatico del driver JDBC
        // a veces no se dispara igual que en una app de consola. Cargamos la
        // clase explicitamente para forzar su registro en el DriverManager.
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
        } catch (ClassNotFoundException e) {
            System.err.println("No se encontro el driver de MySQL en el classpath: " + e.getMessage());
        }
    } /**
